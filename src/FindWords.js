...
function FindWords({columns, doSearchKeyword, doSearchUpdate, createGrid, columnsFrom, updateGridHighlights, updateGridHighlightsOverride, k, n, start, keyword}) {
  // word list
  ...
  return (
    <>
      ...
      <p><Experiment5 wordList={wordList} k={k} n={n} start={start} keyword={keyword} columns={columns} updateGridHighlights={updateGridHighlights} updateGridHighlightsOverride={updateGridHighlightsOverride}/></p>
    </>
  );
}
